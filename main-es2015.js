...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<mat-form-field class=\"full-width\" matTooltip=\"Press Enter To Save\">\n\t<textarea matInput placeholder=\"{{ data.placeholder }}\" [(ngModel)]=\"todoTitle\" rows=\"1\" (keyup.enter)=\"submit()\"></textarea>\n</mat-form-field>");
...
const addTodo = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Todo Component] Add Todo', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const removeTodo = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Todo Component] Remove Todo', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const completeTodo = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Todo Component] Complete Todo', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const editTodo = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])('[Todo Component] Edit Todo', Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
...
/* harmony import */ var _reducers_todo_reducers__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./reducers/todo.reducers */ "./src/app/reducers/todo.reducers.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        ...
        imports: [
            ...
            _ngrx_store__WEBPACK_IMPORTED_MODULE_11__["StoreModule"].forRoot({ state: _reducers_todo_reducers__WEBPACK_IMPORTED_MODULE_12__["todoReducer"] }),
        ],
        providers: [],
    ...
    submit() {
        if (this.todoTitle.trim() !== '') {
            if (this.data.id !== NaN && this.data.id !== undefined) {
                this.store.dispatch(Object(_actions_todo_actions__WEBPACK_IMPORTED_MODULE_5__["editTodo"])({ id: this.data.id, title: this.todoTitle }));
            }
            else if (this.data.id == NaN || this.data.id == undefined) {
                this.store.dispatch(Object(_actions_todo_actions__WEBPACK_IMPORTED_MODULE_5__["addTodo"])({ title: this.todoTitle }));
            }
        }
...
/* harmony import */ var _actions_todo_actions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../actions/todo.actions */ "./src/app/actions/todo.actions.ts");
...
let TodoListComponent = class TodoListComponent {
    constructor(dialog, store, route) {
        ...
        this.edit$ = route.data.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(d => d.edit));
    }
    openDialog(placeholder, title, id) {
    ...
    clickComplete(id) {
        this.store.dispatch(Object(_actions_todo_actions__WEBPACK_IMPORTED_MODULE_7__["completeTodo"])({ id: id }));
    }
    removeTodo(id) {
        this.store.dispatch(Object(_actions_todo_actions__WEBPACK_IMPORTED_MODULE_7__["removeTodo"])({ id: id }));
    }
    items() {
        var res = '';
...
TodoListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./todo-list.component.scss */ "./src/app/components/todo-list/todo-list.component.scss")).default]
    })
], TodoListComponent);
...
var todoId = 3;
const _todoReducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_todo_actions__WEBPACK_IMPORTED_MODULE_2__["addTodo"], (state, { title }) => {
    state.push({ id: todoId, title: title, completed: false });
    todoId += 1;
    return state;
}), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_todo_actions__WEBPACK_IMPORTED_MODULE_2__["removeTodo"], (state, { id }) => {
    return state.filter(todo => todo.id != id);
    ;
}), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_todo_actions__WEBPACK_IMPORTED_MODULE_2__["completeTodo"], (state, { id }) => {
    let arr = state.map(obj => obj.id !== id ? obj : { id: obj.id, title: obj.title, completed: !obj.completed });
    return arr;
}), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions_todo_actions__WEBPACK_IMPORTED_MODULE_2__["editTodo"], (state, { id, title }) => {
...
module.exports = __webpack_require__(/*! /home/kylin/Desktop/todo-app/src/main.ts */"./src/main.ts");
